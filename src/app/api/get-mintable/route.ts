...
const ABI_MINT_V5 = [{"inputs":[{"internalType":"uint256","name":"amountMint","type":"uint256"}],"name":"mintToken","outputs":[{"internalType":"uint256","name":"amount","type":"uint256"}],"stateMutability":"nonpayable","type":"function"}]
